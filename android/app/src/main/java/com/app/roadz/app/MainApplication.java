...
import com.app.roadz.Utils.FontsOverride;
import com.app.roadz.Utils.Utils;
import com.app.roadz.modules.Splash.SplashActivity_;
...
//    public static List<TCurrency> currency=new ArrayList<>();
    ...
    public void onCreate() {
        ...
        typeface = Typeface.createFromAsset(getAssets(), ISlocaleArabic(this)?"fonts/cairo_regular.ttf":"fonts/hkgrotesk_regular.otf");
        typeface_semibold = Typeface.createFromAsset(getAssets(), ISlocaleArabic(this)?"fonts/cairo_semibold.ttf":"fonts/hkgrotesk_semibold.otf");
        typeface_bold = Typeface.createFromAsset(getAssets(), ISlocaleArabic(this)?"fonts/cairo_bold.ttf":"fonts/hkgrotesk_bold.otf");
