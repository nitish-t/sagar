...
//    }
    override var type : BaseRequestHTTPMethod {
        switch self.route {
        case .login,.forgetPassword,.registration,.update,.logout,.update_password,.update_token,.check_register_data,.notifications_read,.resend_email,.update_notification_status,.get_notification_status_update:
            return .post
